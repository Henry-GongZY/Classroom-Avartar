...
class PoseDetector():
    ...
    def find_pose(self, img, draw=True):
        ...
        #识别这帧图片中的人体姿势数据，保存到self.results中
    ...
    def find_positions(self, img):
        ...
        if self.results.pose_landmarks:
            for id, lm in enumerate(self.results.pose_landmarks.landmark):
                ...
                self.pointlist.append([id, cx, cy])
    ...
    def find_angle(self, img, p1, p2, p3, draw=True):
        ...
        :return: 角度
        '''
        x1, y1 = self.pointlist[p1][1], self.pointlist[p1][2]
        x2, y2 = self.pointlist[p2][1], self.pointlist[p2][2]
        x3, y3 = self.pointlist[p3][1], self.pointlist[p3][2]
